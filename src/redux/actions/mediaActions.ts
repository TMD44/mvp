...
export const addMedia = (media: AllMediaType) => ({
    type: ADD_MEDIA,
    payload: media,
});

export const addMediaAtOnce = (media: AllMediaType) => ({
    type: ADD_MEDIA_AT_ONCE,
    payload: media,
});

export const addToMedia = (id: string, media: MetadataType) => ({
    type: ADD_TO_MEDIA,
    payload: { id, media },
});

export const addCoverToMedia = (id: string, media: string) => ({
...
export const deletePlaylist = (playlist: string) => ({
...
export const addMediaToPlaylist = (
    title: string,
    media: MoviesDataType | TvSeriesDataType,
    playlist: string
) => ({
...
export const deleteMediaFromPlaylist = (title: string, playlist: string) => ({
