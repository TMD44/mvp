...
Az alábbi paranccsal teszt média fájlokat lehet generálni. Az így létrehozott videófájlok, feliratfájlok, NFO fájlok természetesen nem valós vagy sérült fájlok lesznek, tehát például a videófájlokat nem lehet lejátszni, de a Scannelés ellenőrzéséhez tökéletesen elegendőek.
\lstset{caption={Teszt fájlok generálása}, label=src:bash}
\begin{lstlisting}[language={Bash}, numbers={none}]
    yarn generate-media
\end{lstlisting}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{media_details.jpg}
	\caption{Filmek, Sorozatok}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{playlists_1.jpg}
