...
\lstset{caption={Repository klónozása}, label=src:cmd}
...
\lstset{caption={Függőségek telepítése Yarn segítségével}, label=src:cmd}
\begin{lstlisting}[language={cmd}, numbers={none}]
    yarn
\end{lstlisting}
...
\lstset{caption={Fejlesztői verzió futtatása}, label=src:cmd}
\begin{lstlisting}[language={cmd}, numbers={none}]
    yarn start
\end{lstlisting}
...
\lstset{caption={Produkciós verzió futtatása}, label=src:cmd}
\begin{lstlisting}[language={cmd}, numbers={none}]
    yarn build
\end{lstlisting}
...
\lstset{caption={Produkciós verzió létrehozása}, label=src:cmd}
\begin{lstlisting}[language={cmd}, numbers={none}]
    yarn package
