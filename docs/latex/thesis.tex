...
\proposaltitle{Multimédia Vizualizációs Platform}
...
\input{chapters/2_user.tex}
\cleardoublepage

\input{chapters/3_impl.tex}
\cleardoublepage

\input{chapters/4_sum.tex}
\cleardoublepage

% MINTA ------------------------------------------------- TÖRLDENŐ!
\input{chapters/MINTA/MINTA_1_intro.tex}
\cleardoublepage

\input{chapters/MINTA/MINTA_2_user.tex}
\cleardoublepage

\input{chapters/MINTA/MINTA_3_impl.tex}
\cleardoublepage

\input{chapters/MINTA/MINTA_4_sum.tex}
\cleardoublepage

% Függelékek (opcionális) - hosszabb részletező táblázatok, sok és/vagy nagy kép esetén hasznos
% Appendices (optional) - useful for detailed information in long tables, many and/or large figures, etc.
\appendix
\input{appendices/further_development.tex}
\cleardoublepage
